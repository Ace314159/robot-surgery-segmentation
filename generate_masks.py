...
import cv2
from models import TernausNet11, TeranusNet16, AlbuNet34
import torch
...
def get_model(model_path, model_type='TN11', problem_type='binary'):
    """
    ...
    if model_type == 'TN11':
        model = TernausNet11(num_classes=num_classes)
    elif model_type == 'TN16':
        model = TeranusNet16(num_classes=num_classes)
    elif model_type == 'AB':
